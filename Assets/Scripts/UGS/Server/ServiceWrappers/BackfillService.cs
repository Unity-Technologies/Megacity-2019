...
namespace Unity.Services.Samples.GameServerHosting
{
    ...
    public class BackfillService : IDisposable
    {
        ...
        List<string> m_ConnectedPlayerIds = new List<string>();
        Dictionary<string, DateTime> m_MissingPlayers = new Dictionary<string, DateTime>();

        public BackfillService(string connection, string queueName, MatchProperties matchmakerPayloadProperties, int maxPlayers)
        {
...
#pragma warning restore 4014
        ...
        private List<string> CompareBackfillWithConnectedPlayerIds()
        {
            ...
            return backfillPlayerIds.Except(m_ConnectedPlayerIds).ToList();
        }
