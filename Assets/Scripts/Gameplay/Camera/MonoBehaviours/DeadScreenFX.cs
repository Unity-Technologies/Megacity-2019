...
namespace Unity.Megacity.CameraManagement
{
    ...
    public class DeadScreenFX : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            m_CachedTextureLut = new Texture2DParameter(((Texture)m_ChromaticAberration.spectralLut), m_ChromaticAberration.spectralLut.overrideState);
            m_TextureLutParameter = new Texture2DParameter(m_TextureLut, true);
        ...
        public void StopGeneratingEffect()
        {
            ...
            {
                m_ChromaticAberration.spectralLut = m_CachedTextureLut;
        ...
        private void Update()
        {
            ...
            {
                m_ChromaticAberration.spectralLut = m_TextureLutParameter;
