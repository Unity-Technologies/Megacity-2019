    ...
    public partial struct PlayerColorSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
                         ...
                         .WithAll<SetPlayerColorTag>())
            {
                ...
                //UnityEngine.Debug.Log($"Setting player {ghostOwner.ValueRO.NetworkId} color to {deterministicColor}! linkedEntityGroup: {linkedEntityGroup.Length}!");
